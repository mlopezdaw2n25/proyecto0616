...
<head>
    ...
    <title>Confirma el teu compte – {{ $appName }}</title>
    <style>
...
<body>
    <div class="wrapper">
        <div class="header">
            ...
            <p>Estàs a un pas de formar part de {{ $appName }}</p>
        </div>

        <div class="body">
            <p>Gràcies per registrar-te! Per activar el teu compte, fes clic al botó de sota.</p>
            <p>
            ...
            <div class="security-note">
                ...
                Si no t'has registrat a {{ $appName }}, ignora aquest correu.
                L'enllaç caducarà automàticament i no es crearà cap compte.
            </div>
        </div>

        <div class="footer">
            &copy; {{ date('Y') }} {{ $appName }} &mdash; Correu automàtic, si us plau no responguis a aquest missatge.
        </div>
    </div>
</body>
</html>
